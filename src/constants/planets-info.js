...
const MERCURY = {
  ...
  radius: '2,439.7 KM',
  averageTemp: '430 ºC',
  activeColor: COLORS.mercuryAccent,
  planetWidth: '111px'
};
...
const VENUS = {
  ...
  radius: '6,051.8 KM',
  averageTemp: '471 ºC',
  activeColor: COLORS.venusAccent,
  planetWidth: '253px'
};
...
const EARTH = {
  ...
  radius: '6,371 KM',
  averageTemp: '16 ºC',
  activeColor: COLORS.earthAccent,
  planetWidth: '173px'
};
...
const JUPITER = {
  ...
  radius: '69,911 KM',
  averageTemp: '-108 ºC',
  activeColor: COLORS.jupiterAccent,
  planetWidth: '224px'
};
...
const SATURN = {
  ...
  radius: '58,232 KM',
  averageTemp: '-138 ºC',
  activeColor: COLORS.saturnAccent,
  planetWidth: '256px'
};
...
const URANUS = {
  ...
  radius: '25,362 KM',
  averageTemp: '-195 ºC',
  activeColor: COLORS.uranusAccent,
  planetWidth: '176px'
};
...
const NEPTUNE = {
  ...
  radius: '24,622 KM',
  averageTemp: '-201 ºC',
  activeColor: COLORS.neptuneAccent,
  planetWidth: '173px'
};

//mercury: tiene que coincidir con {name} de planets, que saco de route
